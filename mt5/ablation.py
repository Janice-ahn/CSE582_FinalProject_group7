...
class DataArguments:
    ...
    ablation_mode: Optional[str] = field(default=None, metadata={"help": "Ablation options"})
...
def main():
    ...
    def preprocess_function(examples):
        ...
        if not data_args.ablation_mode:
            args = (
                    (examples[sentence1_key],) if sentence2_key is None else (examples[sentence1_key], examples[sentence2_key])
                )
        elif data_args.ablation_mode == "S1":
            args = (
                (examples[sentence1_key],)
            )
        elif data_args.ablation_mode == "S2":
            args = (
